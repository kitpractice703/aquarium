...
export const useThemeSection = () => {
  ...
  const themeData: ThemeItem[] = [
    { id: 0, title: "빛의 바다", desc: "얕은 바다의 산호초와 공생하는 생명들의 화려한 춤", img: lightSeaImg, color: "#ffdd57" },
    { id: 1, title: "균형의 바다", desc: "먹이사슬의 정점과 저변, 생태계의 완벽한 조화", img: balanceSeaImg, color: "#64ffda" },
    { id: 2, title: "깊은 바다", desc: "빛이 닿지 않는 곳, 발광 생물들의 신비로운 기록", img: deepSeaImg, color: "#e040fb" },
    { id: 3, title: "지켜야 할 바다", desc: "사라져가는 것들에 대한 기록 그리고 우리의 실천", img: protectSeaImg, color: "#69f0ae" },
  ];
  ...
  return { themeData, handleCardClick, closeModal, isModalOpen, selectedThemeId };
};
