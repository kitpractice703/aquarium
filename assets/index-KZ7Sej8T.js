...
`,A5="/assets/main_video-BXPwnFPC.mp4",C5=({onBookClick:l})=>p.jsxs(b5,{children:[p.jsx(x5,{autoPlay:!0,loop:!0,muted:!0,playsInline:!0,src:A5}),p.jsxs(S5,{children:[p.jsxs(E5,{children:["보이지 않던 바다,",p.jsx("br",{}),"그 너머의 기록"]}),p.jsxs(T5,{children:["빛, 균형, 깊이, 그리고 공존...",p.jsx("br",{}),"신비로운 테마로 펼쳐지는 심해 탐험에 여러분을 초대합니다."]}),p.jsx(w5,{onClick:l,children:"관람 예매하기"})]})]}),R5=z.div`
  width: 100%;
  height: 500px;
  border-radius: 15px;
  overflow: hidden;
...
`,$5="/assets/light_sea-CfjPNMao.mp4",Z5="/assets/balance_sea-L3wEW-zP.mp4",K5="/assets/deep_sea-520AfteG.mp4",J5="/assets/protect_sea-Co7w9cEV.mp4",Ss=[{id:0,title:"빛의 바다",color:"#ffdd57",video:$5,desc:`햇빛이 수면 위에서 부서지며 만들어내는 찬란한 빛의 파동.
