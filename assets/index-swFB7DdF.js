...
`;fv.createRoot(document.getElementById("root")).render(p.jsxs(j.StrictMode,{children:[p.jsx(w3,{}),p.jsx(Db,{basename:"/aquarium",children:p.jsx(NE,{children:p.jsx(T3,{})})})]}));
